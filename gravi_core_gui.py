...
def calculation(args):
    ...
    #row_list, col_list = release_list
    # =============================================================================
    # for i in range(len(row_list)):
...
class Simulation(QThread):
    ...
    def calculation(self, release_list):
...
# =============================================================================
    ...
    def run(self):
# =============================================================================
#         for job in range(self.numberofprocesses):
...
# =============================================================================
        ...
        #release_list = [divided_rowlist, divided_collist]
        #row_list = divided_rowlist[self.thread]
        #col_list = divided_collist[self.thread]
        
        # Setting up Processes to calculate
# =============================================================================
#         output = mp.Queue()
#         processes = [mp.Process(target = self.calculation, args=(divided_rowlist[x], divided_collist[x], output)) for x in range(self.numberofprocesses)]
#         
#         for p in processes:
#             p.start()
#         
...
#             p.join()
# =============================================================================
        #func = partial(self.calculation, divided_rowlist, divided_collist)
        iterable = []
